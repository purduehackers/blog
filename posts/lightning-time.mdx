...
Like traditional time, Lightning Time is timezone-specific; it is not intended to be a replacement for UTC. **8~0~0** eastern time is **6~0~0** pacific time.
...
If you go to Purdue and have stumbled across this post, we hope you'll check out Purdue Hackers :) Find out when our next event
is happening [here](https://events.purduehackers.com).
