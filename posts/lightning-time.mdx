...
The static colors in this demo are the values we've picked for Purdue Hackers, and the default across the Lightning Time tooling
we've built. But you could replace them with anything!
