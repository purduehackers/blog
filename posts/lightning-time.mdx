...
Lightning Time is a spin on hexadecimal time: the day is split into 16 parts, then 16 again, then 16 again, and so on.
...
0-255 (AKA 256 possible combinations), hexadecimal goes from 0-15 (AKA 16 possible combinations), and 16\*16 = 256.
