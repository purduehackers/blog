...
date: 2022-10-20
authors: '[Matthew Stanciu](https://github.com/MatthewStanciu.png),[Neil](https://media.discordapp.net/attachments/1014720593607802972/1031424440308879451/unknown.png),[Reece Ausmus](https://media.discordapp.net/attachments/905833672849113113/1031582305686405171/image0.jpg),[Jack](https://github.com/Athryx.png)'
...
Lightning Time is a spin on hexadecimal time: the day is split into 16 parts, then 16 again, then 16 again, and so on. In other words: instead of there being 24 hours in a day, 60 minutes in an hour, 60 minutes in a second, there are 16 "hours" in a day, 16 "minutes" in an hour, 16 "seconds" in a minute, and so on.

<img src="/posts/lightning-time/timeline-1.jpg" full="true" />
...
`00`, `40`, `80`, `c0`, and `f0`. Try changing all the numbers within [0, 255] and see if you can find a color combination
