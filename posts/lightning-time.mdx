...
If you want to get more of a feel for how Lightning Time colors work, try playing around with them! Below are the static color values
we picked for the color representation of Lightning Time in this post represented as RGB values, along with the full color when the dynamic value is
`00`, `40`, `80`, `c0`, and `f0`. Try changing all the numbers and see if you can find a color combination that looks good for you. 🌈

<div className="flex flex-col w-8/12 md:w-auto md:flex-row gap-4 font-main mx-auto">
