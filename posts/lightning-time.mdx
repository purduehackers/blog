...
date: 2022-10-20
authors: '[Matthew Stanciu](https://github.com/MatthewStanciu.png),[Neil](https://media.discordapp.net/attachments/1014720593607802972/1031424440308879451/unknown.png),[Reece Ausmus](https://media.discordapp.net/attachments/905833672849113113/1031582305686405171/image0.jpg),[Jack](https://media.discordapp.net/attachments/905833672849113113/1032444231798771742/3c6ccb83716d1e4fb91d3082f6b21d77.png)'
...
values for Lightning Time represented as RGB values (0-255), along with the full color when the dynamic value is
`00`, `40`, `80`, `c0`, and `f0`. Try changing all the numbers and see if you can find a color combination that looks good to you. 🌈
(Hint: make big changes to the numbers, or you won't notice any changes)
