...
You’ll know you’re succeeding if you start to see natural momentum that isn’t directly facilitated by leadership, and strong friend groups begin to spawn out of your org.
...
This serves two goals. First, it keeps momentum going, which keeps people engaged. Second, it’s a way of deeply encoding your org’s values and culture into its practices, which makes it harder to lose them “by accident”, or without an intentional and focused shift away from them. If a leader is playing Telephone, the Current will push them toward maintaining the initiatives.
...
Steps 5 and 6—documentation & succession—are the most important defenses against Telephone, and also the hardest to do right. They’re the ones that the founders of collegiate hackathons didn’t do, which is why the original visions were lost so quickly.

Without step 5, the entire foundation of your org is humans who will eventually leave. It could magically change the lives of everyone who’s part of it for a while, but it will collapse when the humans supporting it move on.

Without step 6, you dramatically increase the risk of someone turning the org into a zombie version of itself, going through the motions but with no inspiration or meaningful output. The first four steps build inertia against this, but inertia only goes so far.

Steps 5 and 6 are also where Purdue Hackers is currently the weakest, and my focus next year will be building them both up.
