...
But overall, we’re failing hard here. None of what Purdue Hackers is today exists outside the minds of the current generation. [more assessment]
...
If there are no freshman hackers around, a sophomore who became a hacker via the org is a good candidate too. Juniors should be avoided because they will be seniors by the time they begin leading the org, and we want to avoid single-year terms.
