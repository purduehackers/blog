...
Without step 4, the entire foundation of your org is humans who will eventually leave. You can build the most beautiful house on top of them, which magically changes the lives of everyone who steps inside, but it will collapse when the humans supporting it leave.

Without step 5, you dramatically increase the risk of someone who doesn’t know what they’re doing setting the whole thing on fire. The first three steps build fire resistance, but the fire will eventually win if it’s allowed or encouraged to burn.
...
But it’s true that there’s no guarantee the Plan will succeed. I have never done this successfully before—and sadly, psychohistory is a fictional science, so there’s no precise mathematical logic backing it. The best way to know if it’s a good idea is to come back in 5 years and see how Purdue Hackers is doing.

I’m also aware that I take this whole thing absurdly seriously. I can’t help it: [I just think college clubs are really special and worth investing in.](https://blog.purduehackers.com/posts/college-clubs-are-awesome) But although the Plan does require lots of thought and care, it does not require its facilitator to be nearly as laser-focused as I have been. The rate at which Purdue Hackers has changed under my leadership has been quite steep, but there’s value in slower evolutions that happen over multiple generations.
