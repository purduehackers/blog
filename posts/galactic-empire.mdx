...
I am so glad I chose to deeply invest in this org, and am extremely proud of its rapid transformation and acceleration over the last two years. But I am also concerned for its future: running a high-quality student org should not require its leader to drop everything to work on it full time, and we shouldn’t expect any future leader to do so. More importantly, none of what Purdue Hackers is today exists outside the minds of the current generation: if we were to graduate today, much of what we know of as Purdue Hackers would be lost. If Purdue Hackers is to survive the next 11 years and beyond, both of these things must change. I want to share how I plan on achieving this–and, in doing so, carve a path that other org leaders can follow too.
...
Ten years later, the landscape looks very different. Most of the big players in tech no longer sponsor hackathons, and most hackathons have established deep relationships with regional companies, which regularly sponsor them every year. Many university CS departments also now set aside budget every year for their hackathons. At the time of the Big Bang, collegiate hackathons were a new idea proposed by renegades who were forging a new path; today, the paths are very visible and well-established, with deep grooves.

But despite ten years of independent evolution, the grooves formed by nearly every North American collegiate hackathon reveal uncannily similar pictures, as if trending toward an ideal state of matter.
...
But we’re failing on nearly every other point. None of our technical knowledge is documented anywhere, and we’re currently on a path for it all to be lost: how to make a passport, how to design a badge, how to run Hack Night, how to run a workshop, brand guidelines. And although our values are encoded into a lot of our communications, none of them are explicitly written down anywhere.

Creating and maintaining up-to-date documentation is something most orgs—not just student orgs—are bad at. It’s often lower priority because it’s not an immediate need, but the activation energy required to do it right is too high when it is needed. Student orgs are especially bad at this for the same reason they’re especially vulnerable to Telephone.

My plan for getting past the activation energy problem of documentation is to create an initiative out of it, similar to badges or passports. The goal is to make it so that we _must_ build our own _Encyclopedia Galactica_, and maintaining it should be expected of everyone who contributes something to Purdue Hackers. I’m calling this initiative _Evergreen_, and I’m sure I will share more about it as it gets going this fall.
...
Steps 4 and 5 are also where Purdue Hackers is currently the weakest, and my focus next year will be building them both up.
...
But it’s true that there’s no guarantee the Plan will succeed. I have never done this successfully before—and sadly, psychohistory is a fictional science, so there’s no precise mathematical logic backing it. The only way to know if it’s a good idea is to come back in 5 years and see how Purdue Hackers is doing.

I’m also aware that I take this whole thing absurdly seriously. I can’t help it: [I just think college clubs are really special and worth investing in.](https://blog.purduehackers.com/posts/college-clubs-are-awesome) But although the Plan requires lots of thought and care, it does not require its facilitator to be nearly as laser-focused as I have been. The rate at which Purdue Hackers has changed under my leadership has been quite steep, but there’s value in slower evolutions that happen over multiple generations.

I’m ready to bet on Purdue Hackers. I’m excited to see the Plan through over the next year, and I can’t wait for what the next 100 years will bring!
