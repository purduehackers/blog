...
ogDescription: The new, new Hack Night—now at the Bechtel Center. A recap.
---
...
- **Sessions**: informal & experimental workshops. This can include challenges, dry runs of upcoming workshops, themes, or workshops that don't work as standalone events. Often spearheaded by community members who want to teach something they think others will be excited about.
...
Hack Night 2.0 is the biggest leap yet: our venue moved to the local makerspace, events were assigned colors, and we were joined by engineers from [Caesar Creek Software](https://cc-sw.com).

# The Venue

Hack Nights 0.x and 1.x were held in a classroom in Purdue's Wilmeth Active Learning Center (WALC). WALC is known for modern classrooms with a collaborative environment, which were a great match for Hack Night—but they were still classrooms. We thought we we could do better.

Most Purdue students don't know that we have entire makerspace on campus, but we do. It's called the [Bechtel Innovation Design Center](https://www.purdue.edu/bidc/), and it opened in 2020. Every Hack Night badge is made with the nonmetal laser cutter at the Bechtel Center!

The Bechtel Center is a marvellous space. Study spaces of all kinds—desks with computers, couches, collaborative alcoves with TVs, conference rooms, and a kitchen—curve around glass walls from floor to ceiling; behind the glass walls is a room full of all the maker machines you can dream of. It's like a zoo, except instead of animals it's full of maker machines. When I stepped out of my first laser cutter session last November, I knew we needed to run Hack Night here.

# The Day Of

Doors opened at 8:00pm, and hackers flooded in. Opening ceremony began at 8:30pm; hacking began 10 minutes later.
...
At midnight, we continued the longstanding tradition of counting down until midnight—or `0~0~0` in Lightning Time.
...
<iframe
  ...
  width="100%"
  src="https://www.youtube.com/embed/iOTNc4vM3T0?autoplay=0&amp;mute=0&amp;controls=1&amp;origin=https%3A%2F%2Fblog.purduehackers.com&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;iv_load_policy=3&amp;modestbranding=1&amp;enablejsapi=1&amp;widgetid=39"
  id="widget40"
></iframe>
