...
41 passports have been made across 6 passport-making ceremonies in just over 2 months.
...
One such project is [Passport Authority](https://github.com/purduehackers/passport-authority), the iOS app we made to activate passports at passport-making ceremonies. Passport Authority allows us to view a list of passports made on the data pages website, then activate a passport by writing the proper records to its NFC sticker and marking it activate in the database. We sign into this app with our own passports.
...
By the end of the semester, we will also ship a dashboard for passport owners which will allow them to turn on 2FA, manage their passport, collect digital versions of Hack Night badges, and play a custom sound when they use the door opener at Hack Night, among other things.

Currently, no user-facing apps building on top of `id` have shipped to production; having a passport is being an early adopter. Even so, lots of folks have been excited to make their own passports. We're really excited for the infrastructure we're building to level up their passports in the coming months.
