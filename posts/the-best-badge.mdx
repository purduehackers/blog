...
We weren’t done: Jack and Matthew wrote a script, then recorded the message to be played on the phone. Meanwhile, Hazel used ElevenLabs to ask for a password, displayed on top of the website pointed to by the ASCII codes, then edited both files and put them into the phone.
...
Anticipating that people may have difficulty