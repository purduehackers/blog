...
ICYMI: Hack Night is an event that we've started running this year. Every Friday night, from 7:00 PM ([c~a~a|a](https://blog.purduehackers.com/posts/lightning-time)) onwards, we provide uninterruped time to work on personal projects. There's [a cool dashboard](https://github.com/purduehackers/night), and the energy has been wonderful every time.
