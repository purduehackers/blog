...
3. If you're building for everyone, you're building for no one. Everyone who wants to work in tech is worried about passing coding interviews and finding a high-paying job, so for sure you'll get numbers by appealing to these worries—but I think it's a pretty lowest-common-denominator, unimaginative thing to build for, and it makes it difficult to form a strong identity as a community. Surely there are better, more positive things you can appeal to than CS majors' box-checking nightmares!
4. It assumes that technical work can only be done by CS majors—but in reality, one's major is a weak indicator of how technical they are. Many of the most impressive projects in Purdue Hackers's community were made by non-CS majors.
