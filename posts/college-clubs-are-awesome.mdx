...
I think many college CS clubs are optimizing for the wrong things—but despite this, I think the college club format, like a Minecraft server, contains an endless number of hidden gems which can make them uniquely amazing if used.
...
This is the hidden gem of the college club format. The ability for a college club to be something that resembles a startup—building real software for real users—but without any of the real-world constraints that startups face, is incredibly magical, and cannot exist outside the realm of a college club.

It sounds like a pipe dream, but it exists today, in the form of Purdue Hackers.

---

Consider the potential future of a club that operates with this format. Once you've created a community in which:

- people are contributing to open source every day
- everyone is working on a project of some sort—software, hardware, art, whatever
- people are regularly making new friends

It's only a matter of time before you'll create world-class engineers. Seriously! One of the great things about computers is that you can become a subject-matter expert on some part of them on your own in 3-5 years with consistent practice—which, excitingly, is around the time most people spend in college. Imagine a popular open-source project used by real people in the world on a college club's GitHub org, maintained by its members. I believe something like that is in Purdue Hackers' future.

I've emphasized that the software we build is used by real people, but I also want to highlight that college club software can be stupid and intended to be used by nobody! Lightning Time is a great example: it's an esoteric art project that will never be seriously used by anybody. I don't think that's a bad thing; in fact, I think it being created by & for a college club has given it life. If it were an individual's personal project, it wouldn't mean anything to anyone—but as a college club project, it has inspired creative projects and shaped our community's identity.
