...
pubDate: 2022-10-20
authors: ['[Matthew Stanciu](https://github.com/MatthewStanciu.png)','[Neil]()','[Reece Ausmus]()','[Jack](https://github.com/Athryx.png)']
description: A new way to measure time, by Purdue Hackers
---

import LightningText, {
  LightningPart
} from '../../react/posts/lightning-time/lightning-text'
import ColoredLightningString from '../../react/posts/lightning-time/colored-lightning-string'
import ColorsDemo from '../../react/posts/lightning-time/colors-demo'
import ColorToy from '../../react/posts/lightning-time/color-toy'
import ConvertToLightning from '../../react/posts/lightning-time/convert-to-lightning'
import ConvertFromLightning from '../../react/posts/lightning-time/convert-from-lightning'
